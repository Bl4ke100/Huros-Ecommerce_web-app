    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 bg-light text-center">
                <label class="form-label text-primary fw-bold fs-1">Manage Products</label>
            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="offset-4 col-4">
                                    <img src="<?php echo ($image_data["code"]); ?>" class="img-fluid" style="height: 100px;" />
                                </div>
                                <div class="col-12">
                                    ...
                                    <span class="fs-5">Vihanga</span><br />
                                </div>
