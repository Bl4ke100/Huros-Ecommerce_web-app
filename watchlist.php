                ...
                <div class="row">
                    <div class="col-12 border border-1 border-primary rounded mb-2">
                        <div class="row">
                            ...
                            <div class="col-11 col-lg-2 border-0 border-end border-1 border-primery">
                                            ...
                                            for($x = 0;$x < $watch_num;$x++){                                              
                                                ...
                                                <!-- have Products -->
                                                    ...
                                                    <div class="card mb-3 mx-0 mx-lg-2 col-12">
                                                        <div class="row g-0">
                                                            <div class="col-md-4">
                                                                <img src="<?php echo $pi ;?>" class="img-fluid rounded-start"/>
                                                            </div>
                                                            <div class="col-md-5">
                                                                <div class="card-body">
                                                                    <h5 class="card-title fs-2 fw-bold text-primary"><?php echo $p_data["title"]?></h5>
                                                                    <span class="fs-5 fw-bold text-black-50">Colour : <?php echo $col_data["name"]?></span>
                                                                    &nbsp;&nbsp; | &nbsp;&nbsp;
                                                                    ...
                                                                    <span class="fs-5 fw-bold text-black">Rs. <?php echo $p_data["price"]?> .00 </span><br/>
                                                                    <span class="fs-5 fw-bold text-black-50">Quantity : </span> &nbsp;&nbsp;
                                                                    <span class="fs-5 fw-bold text-black"><?php echo $p_data["qty"]?> Items Availabel</span><br/>
