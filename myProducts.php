                        ...
                        <div class="col-12 col-lg-4">
                            <div class="row">
                                <div class="col-12 col-lg-4 mt-1 text-center">
                                    ...
                                    ?>
                                        <img src="<?php echo $Profile_image_data["path"]; ?>" width="90px" class="rounded-circle" />

                                    <?php

                                    } else {
                                    ?>
                                        <img src="resource/new user.svg" width="90px" height="90px" class="rounded-circle" />
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-9 mt-3 mb-3 bg-white">
                            <div class="row">
                                <div class="offset-1 col-10 text- text-center">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="card-body">
                                                            ...
                                                            <span class="card-text fw-bold text-success"><?php echo $selected_data["qty"];?> Items available</span>
                                                            <div class="form-check form-switch">
                                                               ...
                                                               <label class="form-check-label fw-bold text-info" for="fd<?php echo $selected_data["id"];?>">
                                                                ...
                                                                <?php if ($selected_data["status_id"]==2){?>
                                                                    Make Your Product Active</label>
                                                                    <?php }else{?>
