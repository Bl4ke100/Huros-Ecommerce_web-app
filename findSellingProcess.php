                ...
                <div class="row">
                    ...
                    <div class="col-2 bg-white d-grid">
                        ...
                        if($selected_data["status"] == 0){
                            ...
                            ?>
                                <button class="btn btn-danger fw-bold  mt-1 mb-1 disabled" onclick="changeStatus('<?php echo $selected_data['id'];?>');" id="btn<?php echo $selected_data['id'];?>">Deliverd</button>
                            <?php
                        }
                        ?>
                    </div>
