...
<body class="modern-auth-body">
    ...
    <style>
        ...
        * {
        ...
        .match-text.match::before {
            background: #28a745;
        }

        .match-text.no-match::before {
            background: #dc3545;
        }

        /* Enhanced focus states for password inputs */
                ...
                <div class="auth-form">
                    ...
                    <form class="auth-form-fields">
                        <div class="form-group">
                            ...
                            <div class="password-input-wrapper">
                                <input type="password" id="np" class="form-input" placeholder="Enter your new password">
                                <button type="button" class="password-toggle" onclick="togglePassword('np')">
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-input-wrapper">
                                <input type="password" id="np2" class="form-input" placeholder="Re-enter your new password">
                                <button type="button" class="password-toggle" onclick="togglePassword('np2')">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
                                        <circle cx="12" cy="12" r="3" />
                                    </svg>
                    ...
                    <div class="security-note">
                        ...
                        <div class="security-text">
                            ...
                            <p>Choose a strong password that you haven't used before. Avoid using personal information.</p>
                        </div>
                    </div>
                </div>
            </div>
