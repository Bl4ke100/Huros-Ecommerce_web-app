   ...
   <div class="container-fluid">
      <div class="row">
         ...
         ?>
                              ...
                              <div class="col-12">
                                 <div class="row">
                                    <div class="col-12 col-lg-1 bg-info text-center text-lg-start">
                                       <label class="form-label text-white text-white fs-6 py-5"><?php echo $invoice_data["id"]; ?></label>
                                    </div>
                                          ...
                                          <div class="row g-0">
                                             ...
                                             <div class="col-md-8">
                                                <div class="card-body">
                                                   ...
                                                   <div class="card-text"><b>Seller : </b><?php echo $seller_data["fname"]." ".$seller_data["lname"]; ?></div>
                                    ...
                                    <div class="col-12 col-lg-3">
                                       <div class="row">
                                          ...
                                          <div class="col-6 d-grid">
                                             <button class="btn btn-danger fs-5 rounded mt-5 border-primary"><i class="bi bi-trash3-fill"></i> Delete</button>
                                          </div>
                                       </div>
                                    </div>
                     ...
                     <div class="col-12 mb-3">
                        <div class="row">
                           <div class="offset-lg-10 col-12 col-lg-2 d-grid mb-3">
                              <button class="btn btn-danger"><i class="bi bi-trash3-fill"></i> Delete All Records
                           </div></button>
                        </div>
                     </div>
            ...
            <div class="col-12">
               <div class="row">
                  <div class="col-12 sadFace"></div>
                  <div class="col-12 text-center">
                     <label class="form-label fs-1 fw-bold">Please Log In first</label>
                  </div>
                  <div class="offset-lg-4 col-12 col-lg-4 d-grid mb-3">
                     <a href="index.php" class="btn btn-outline-success fs-3 fw-bold">Log In</a>
                  </div>
               </div>
            </div>
         <?php
