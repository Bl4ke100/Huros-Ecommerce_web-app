...
if(isset($_POST["email"])&& isset($_POST["name"])){
    if($_SESSION["au"]["email"] == $_POST["email"]){
        ...
        if($category_num ==0){
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'vihanganethmini2005@gmail.com';
            $mail->Password = 'hxelexgfwdtleuqa';
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;
            $mail->setFrom('vihanganethmini2005@gmail.com', 'Admin Verification');
            $mail->addReplyTo('vihanganethmini2005@gmail.com', 'Admin Verification');
