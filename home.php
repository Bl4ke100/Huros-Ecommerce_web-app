...
<div class="col-12" id="basicSearchResult">
    ...
    <!--carousel-->
        <div class="col-12 d-none  mb-3 d-lg-block">
            <div class="row"><div id="carouselExampleIndicators" class="offset-2 col-8 carousel slide carousel-fade" data-bs-ride="true">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="resource/slider images/slider images/posterimg.jpg" class="d-block poster-img-1"/>
    ...
    <div class="carousel-item">
      <img src="resource/slider images/slider images/posterimg2.jpg" class="d-block poster-img-1"/>
    </div>
    <div class="carousel-item">
      <img src="resource/slider images/slider images/posterimg3.jpg" class="d-block poster-img-1"/>
      <div class="carousel-caption d-none d-md-block poster-caption-1">
        <h5 class="poster-title">Be Free...</h5>
        <p class="poster-txt">Experience the biggest discounts from us</p>
     </div>
    </div>
  </div>
...
<div class="row border border-primary">
    <div class="col-12">
       ...
       <img src="<?php echo $image_data["code"];?>"class="card-img-top img-thumbnail" style="height:200px;"/>
