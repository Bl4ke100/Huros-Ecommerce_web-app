         ...
         <div class="card mb-3 mt-3 col-12 col-lg-6">
            <div class="row">
               <div class="col-md-4 mt-4">
                  ...
                  // $product_details_rs = Database::search("SELECT * FROM `product` WHERE `id`='".$selected_data["id"]."'");
               ...
               <div class="col-md-8">
                  <div class="card-body">
                     ...
                     <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="fd<?php echo $selected_data["id"]; ?>" onclick="changeStatus(<?php echo $selected_data['id']; ?>);" <?php if ($selected_data['status_id'] == 1) { ?> checked <?php } ?> />
